...
class Product
{
     ...
     * @return Product|false L'instance avec le nouvel ID ou false si échec
     */
    public function create(): Product|false
    {
        ...
        if ($result) {
            // Récupère l'ID auto-généré et l'assigne à l'instance
     ...
     * @return Product|false L'instance mise à jour ou false si échec
     */
